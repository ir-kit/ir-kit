...
- 75f99f1: Add `k6-ts sync` subcommand — generate the typed k6 client from an OpenAPI spec without writing a `scripts/sync.mjs`. Closes the last shell-composability gap in the HAR → typed loadtest pipeline.
