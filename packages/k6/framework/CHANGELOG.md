...
- fc069db: Expand `budgets:` to cover four common cases that previously required dropping to raw `options.thresholds`:
...
- b924e63: Move `@types/k6` from `dependencies` to `peerDependencies` (range widened to `>=1.7.0`).
